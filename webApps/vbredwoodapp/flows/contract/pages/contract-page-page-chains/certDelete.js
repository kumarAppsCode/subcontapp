define([
  ...
  class certDelete extends ActionChain {
    ...
    async run(context, { key, index, current }) {
      ...
      if (current.row.approval_status_code === "Draft" || current.row.approval_status_code === "Rejected") {
        $page.variables.certDeletekey = key;

        const callComponentMethodCertificationDeleteOpenResult = await Actions.callComponentMethod(context, {
