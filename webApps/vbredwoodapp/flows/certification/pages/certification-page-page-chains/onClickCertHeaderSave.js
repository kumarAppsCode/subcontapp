define([
  ...
  class onClickCertHeaderSave extends ActionChain {
    ...
    async run(context) {
      ...
      if ($page.variables.CertificationDetailsVar.approval_status_code === 'Draft') {      if ($application.functions.isFormValid("CertificationHdrForm")) {
